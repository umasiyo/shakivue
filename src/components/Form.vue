...
.radio:checked~.first_setumei {
  display: block;
}
.radio:checked~.second_setumei {
  display: block;
}
.radio:checked~.third_setumei {
  display: block;
}
.radio:checked~.fourth_setumei {
  display: block;
}
/*tuika*/
.contents div {
...
.googleform {
  background: linear-gradient(to right, #E85BFF, #03F0FF);
  color: white;
  filter: drop-shadow(0px 0px 2px #4f4e4e);
}
.hiratasan {
